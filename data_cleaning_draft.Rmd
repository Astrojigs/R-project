...
```
There are many columns with different data types. First we will check if there are any null values. After viewing the data, we see that there are no null values, and also the data points seem to be consistent and not vaguely different. Hence cleaning this file is not necessary.
